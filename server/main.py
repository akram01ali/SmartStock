...
from controllers import components, relationships, tree, graph, analytics, forecasting, manuals, checklists
...
@app.get("/printers-groups-assemblies", response_model=List[ComponentName])
...
async def app_login_compat(
    ...
    return await app_login(request_data["name"], request_data["surname"], db)
